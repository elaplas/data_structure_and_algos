...
6. Return the updated array, but there is trick which helps us to select the starting index of the updated array. Example, [0, 1,  updated array, and we want to2, 4] is the return only [1, 2, 4]
'''
