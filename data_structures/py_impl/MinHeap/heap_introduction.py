...
class Heap:
    ...
    def insert(self, data):
        ...
        cur_parent_index = self.get_parent(cur_index)
        while self.cbt[cur_index] < self.cbt[cur_parent_index]:
            tmp = self.cbt[cur_index]
            self.cbt[cur_index] = self.cbt[cur_parent_index]
            self.cbt[cur_parent_index] = tmp
    ...
    def remove(self):
        ...
        cur_child = 1
        cur_parent = 0
        if self.cbt[2] and self.cbt[2] < self.cbt[1]:
            cur_child = 2
            
        while cur_child < len(self.cbt) and self.cbt[cur_child] and self.cbt[cur_child] < self.cbt[cur_parent]:
            tmp = self.cbt[cur_parent]
            self.cbt[cur_parent] = self.cbt[cur_child]
            self.cbt[cur_child] = tmp
            cur_parent = cur_child
            cur_child = self.get_left_child(cur_child)
    ...
    def get_left_child(self, in_index):
        return (in_index*2) + 1
    
    def get_right_child(self, in_index):
        return (in_index*2) + 2
    
    def get_parent(self, in_index):
        return in_index // 2
